...
G4VPhysicalVolume* DetectorConstruction::Construct() {
    ...
    fStepLimit->SetMaxAllowedStep(0.1 * mm);
    fLBox->SetUserLimits(fStepLimit);
...
void DetectorConstruction::ConstructSDandField() {
    ...
    auto edepSD = new EnergyDepositSD(SDname = "/EnergyDeposit");
    sdManager->AddNewDetector(edepSD);
    fLBox->SetSensitiveDetector(edepSD);
